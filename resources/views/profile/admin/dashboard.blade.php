        ...
        <div class="row">
            ...
            <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Default 12</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="container-fluid">
    <div class="row widget-grid">
                            ...
                            <div class="row g-sm-4 g-2">
                                <div class="col-xl-12 col-md-4">
                                    <div class="light-card balance-card widget-hover">
                                        <div class="svg-box">
                                            <svg class="svg-fill">
                                                <use href="{{asset('backend/assets/svg/icon-sprite.svg#income')}}"></use>
                                            </svg>
                                        </div>
                                ...
                                <div class="col-xl-12 col-md-4">
                                    <div class="light-card balance-card widget-hover">
                                        <div class="svg-box">
                                            <svg class="svg-fill">
                                                <use href="{{asset('backend/assets/svg/icon-sprite.svg#expense')}}"></use>
                                            </svg>
                                        </div>
                    ...
                    <div class="card-body pt-0">
                        <div class="appointment-table table-responsive">
                            <table class="table table-bordernone">
                                <tbody>
                                    <tr>
                                        <td><img class="img-fluid img-40 rounded-circle" src="{{asset('backend/assets/images/dashboard/user/1.jpg')}}" alt="user"></td>
                                    ...
                                    <tr>
                                        <td><img class="img-fluid img-40 rounded-circle" src="{{asset('backend/assets/images/dashboard/user/2.jpg')}}" alt="user"></td>
                                    ...
                                    <tr>
                                        <td><img class="img-fluid img-40 rounded-circle" src="{{asset('backend/assets/images/dashboard/user/3.jpg')}}" alt="user"></td>
                                    ...
                                    <tr>
                                        <td><img class="img-fluid img-40 rounded-circle" src="{{asset('backend/assets/images/dashboard/user/4.jpg')}}" alt="user"></td>
                                    ...
                                    <tr>
                                        <td><img class="img-fluid img-40 rounded-circle" src="{{asset('backend/assets/images/dashboard/user/5.jpg')}}" alt="user"></td>
        ...
        <div class="col-xxl-3 col-md-6 box-col-6 col-ed-none wow zoomIn">
            <div class="card purchase-card"><img class="img-fluid" src="{{asset('backend/assets/images/dashboard/purchase.png')}}" alt="vector mens with leptop">
        ...
        <div class="col-xxl-5 col-lg-8 col-md-11 box-col-8 col-ed-6">
            <div class="card papernote-wrap">
                ...
                <div class="card-body pt-0"> <img class="banner-img img-fluid" src="{{asset('backend/assets/images/dashboard/papernote.jpg')}}" alt="multicolor background">
                    <div class="note-content mt-sm-4 mt-2">
                        ...
                        <div class="mt-sm-4 mt-2 user-details">
                            <div class="customers">
                                <ul>
                                    <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{asset('backend/assets/images/dashboard/user/1.jpg')}}" alt="user"></li>
                                    <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{asset('backend/assets/images/dashboard/user/6.jpg')}}" alt="user"></li>
                                    <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{asset('backend/assets/images/dashboard/user/7.jpg')}}" alt="user"></li>
                                    <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{asset('backend/assets/images/dashboard/user/3.jpg')}}" alt="user"></li>
                                    <li class="d-inline-block"><img class="img-40 rounded-circle" src="{{asset('backend/assets/images/dashboard/user/8.jpg')}}" alt="user"></li>

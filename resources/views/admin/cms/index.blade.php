...
<div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="dt-ext table-responsive">
                        <table class="display" id="cms-table">
                            <thead>
                                <tr>
                                    <th>Title</th>
                                    <th>Description</th>
    ...
    <!-- User Create Modal -->
    <div id="CMS_StructureModal" class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="commonModalLabel" aria-hidden="true">
        ...
        $(document).on('click', '#EditSMSModal', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#CMS_StructureModal .modal-dialog').html(response);
                    $('#CMS_StructureModal').modal('show');
                },
                error: function(xhr, status, error) {
                    console.error(xhr.responseText);
                }
